        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm mb-4">
              Premium paving and masonry services throughout Connecticut with a focus on quality and customer
              satisfaction.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/concrete" className="hover:text-white transition-colors">
                  Concrete
                </Link>
              </li>
              <li>
                <Link href="/services/masonry" className="hover:text-white transition-colors">
                  Masonry
                </Link>
              </li>
              <li>
                <Link href="/services/excavation" className="hover:text-white transition-colors">
                  Excavation
                </Link>
              </li>
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="mb-2">CT, NY</p>
              <p className="mb-4">United States</p>
              <a
                href="tel:+12038884200"
                className="flex items-center space-x-2 hover:text-white transition-colors mb-2"
              >
                <Phone size={16} />
